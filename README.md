Nhận dạng chữ só viết tay dựa trên mô hình Convolution Neural Network (CNN). Trong Source code gồm có file CNN.py dùng để huấn luyện mô hình và lưu dữ liệu đã huấn luyện, 
